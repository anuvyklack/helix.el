...
'(overlay-start
  ...
  jupyter-request-time
  jupyter-request-content
  jupyter-request-id
  jupyter-session-id
  jupyter-server-kernel-server
  jupyter-session-key
  ...
  websocket-protocols
  plist-get
  helix-highlight-buffer
  current-column
  visited-file-modtime
  frame-width
  window-hscroll
  flycheck-error-end-line
  selected-frame
  cdr
  nthcdr
  symbol-function
